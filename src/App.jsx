...
const App = () => {
  ...
  return (
    <div className="app">
      ...
      <div
        className={`blog-panel-overlay ${selectedBlogPost ? "active" : ""}`}
            ...
            <div className="panel-body">
              ...
              <div className="panel-author">
                <img
                  ...
                  alt="Claudenes Santos"
                  className="panel-author-avatar"
                />
                <div className="panel-author-info">
                  <span className="panel-author-name">Claudenes Santos</span>
                  <span className="panel-author-title">
