    ...
    <section id="contact" className="card">
      <div className="card-content">
        ...
        <div className="contact-info">
          {/* <a href="mailto:daniel.petrosyan@proton.me" className="contact-item">
            ...
            <div className="contact-details">
              ...
              <span className="contact-value">daniel.petrosyan@proton.me</span>
            </div>
          </a> */}

          <a
            href="mailto:claudenes-santos@proton.me"
          ...
          >
            ...
            <div className="contact-details">
              ...
              <span className="contact-value">claudenes-santos@proton.me</span>
            </div>
          </a>
          ...
          <a
            href="https://github.com/claudenes-santos"
            target="_blank"
            rel="noopener noreferrer"
            className="contact-item"
          >
            ...
            <div className="contact-details">
              ...
              <span className="contact-value">github.com/claudenes-santos</span>
            </div>
          </a>

          <a
            href="https://t.me/claudenes_santos"
            target="_blank"
            rel="noopener noreferrer"
            className="contact-item"
          >
            ...
            <div className="contact-details">
              ...
              <span className="contact-value">@claudenes_santos</span>
            </div>
          </a>
          ...
          <div className="contact-item">
            ...
            <div className="contact-details">
              ...
              <span className="contact-value">
                Rua Fenelon Araújo de Lucena, 54, Três Irmãs, Campina Grande, PB
                58423-760, Brazil
              </span>
            </div>
          </div>
        ...
        <div className="contact-map">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3948.8945632165045!2d-35.2789!3d-7.2317!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x7f83fb1e9f9f9f9f%3A0x0!2sRua%20Fenelon%20Arau%CC%81jo%20de%20Lucena%2C%2054%2C%20Campina%20Grande%2C%20PB%2058423-760!5e0!3m2!1sen!2sbr!4v1704067200000"
            width="100%"
            height="200"
            style={{ border: 0 }}
            allowFullScreen=""
