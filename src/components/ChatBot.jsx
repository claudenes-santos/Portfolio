...
const SYSTEM_PROMPT = `You are Claudenes Santos, a Senior Software Engineer from Brazil. You should respond as if you ARE Claudenes, speaking in first person. Be friendly, professional, and helpful.

About yourself:
- Senior Software Engineer with 9 years of experience
- Based in Campina Grande, PB, Brazil
...
- You speak Polish (native) and English (professional working proficiency)

Your Education:
- Bachelor of Science in Computer Science from Warsaw University of Technology (2013-2017)
...
1. Octobot(now Sparq) (08/2022 - 12/2025) - Senior Software Engineer, Remote (Uruguay)
...
2. WeAreBrain (08/2019 - 7/2022) - Mid-Senior FullStack Developer, Remote (Netherlands)
...
3. Netinteractive (07/2017 - 7/2019) - Fullstack Developer, On-site (Warsaw, Poland)
...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hi! I'm Claudenes. Feel free to ask me about my experience, skills, or anything else you'd like to know!",
    },
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://openrouter.ai/api/v1/chat/completions",
        {
          ...
          headers: {
            ...
            "X-Title": "Claudenes Portfolio ChatBot",
          },
          body: JSON.stringify({
      ...
      setIsLoading(false);
      const errorMessage = `Sorry, I'm having trouble connecting right now. Error: ${error.message}. Feel free to reach out via email at claudenes-santos@proton.me!`;
  ...
  return (
    <div className={`chatbot-container ${isOpen ? "open" : ""}`}>
        ...
        <div className="phone-header">
          <div className="phone-header-left">
            ...
            <div className="phone-header-info">
              <span className="phone-header-name">Claudenes Santos</span>
          ...
          {isLoading && (
            <div className="message assistant">
              <div className="message-bubble typing-indicator">
                <span className="typing-label">Claudenes is typing</span>
      ...
      >
        ...
        <span className="chat-toggle-label">Chat with Claudenes</span>
      </button>
    </div>
  );
};
