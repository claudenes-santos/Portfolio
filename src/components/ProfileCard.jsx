...
const transitionEffects = ["fade-zoom", "slide-left", "slide-right"];
    ...
    <section className="profile-card card">
      ...
      <div className="profile-photo-wrapper">
        <div className="profile-photo">
          <img src="/image/profile.jpg" alt="Claudenes Santos" />
        </div>
      </div>
      ...
      <div className="profile-content">
        <div className="profile-main">
          <div className="profile-info">
            <h1 className="profile-name">Claudenes Santos</h1>
            <p className="profile-headline">Senior Software Engineer</p>
            <p className="profile-location">
              Campina Grande, PB, Brazil
              <span className="separator">·</span>
              <a href="#contact" className="contact-info-link">
                Contact info
              </a>
            </p>
          </div>
        ...
        <div className="profile-highlights">
          <div className="highlight-box">
            ...
            <p className="highlight-detail">
              Full Stack Developer, Blockchain Engineer, and AI/ML roles
            </p>
